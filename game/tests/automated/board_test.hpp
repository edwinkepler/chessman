...
BOOST_AUTO_TEST_CASE(put_white_pawn_at_chessboard)
{
    ...
    BOOST_REQUIRE_EQUAL(Chessman::PAWN, test_board->ptr_piece(make_pair(1, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE, test_board->ptr_piece(make_pair(1, 1))->owner());
    delete test_board;
    delete test_piece;
}
...
BOOST_AUTO_TEST_CASE(put_black_pawn_at_chessboard)
{
    ...
    test_board->place_piece(make_pair(1, 1), test_piece);
    BOOST_REQUIRE_EQUAL(Chessman::PAWN, test_board->ptr_piece(make_pair(1, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK, test_board->ptr_piece(make_pair(1, 1))->owner());
    delete test_board;
    delete test_piece;
}
...
BOOST_AUTO_TEST_CASE(put_white_rook_at_chessboard)
{
    ...
    test_board->place_piece(make_pair(1, 1), test_piece);
    BOOST_REQUIRE_EQUAL(Chessman::ROOK, test_board->ptr_piece(make_pair(1, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE, test_board->ptr_piece(make_pair(1, 1))->owner());
    delete test_board;
    delete test_piece;
}
...
BOOST_AUTO_TEST_CASE(put_white_knight_at_chessboard)
{
    ...
    test_board->place_piece(make_pair(1, 1), test_piece);
    BOOST_REQUIRE_EQUAL(Chessman::KNIGHT, test_board->ptr_piece(make_pair(1, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE, test_board->ptr_piece(make_pair(1, 1))->owner());
    delete test_board;
    delete test_piece;
}
...
BOOST_AUTO_TEST_CASE(put_white_bishop_at_chessboard)
{
    ...
    test_board->place_piece(make_pair(1, 1), test_piece);
    BOOST_REQUIRE_EQUAL(Chessman::BISHOP, test_board->ptr_piece(make_pair(1, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE, test_board->ptr_piece(make_pair(1, 1))->owner());
    delete test_board;
    delete test_piece;
}
...
BOOST_AUTO_TEST_CASE(put_white_queen_at_chessboard)
{
    ...
    test_board->place_piece(make_pair(1, 1), test_piece);
    BOOST_REQUIRE_EQUAL(Chessman::QUEEN, test_board->ptr_piece(make_pair(1, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE, test_board->ptr_piece(make_pair(1, 1))->owner());
    delete test_board;
    delete test_piece;
}
...
BOOST_AUTO_TEST_CASE(put_white_king_at_chessboard)
{
    ...
    test_board->place_piece(make_pair(1, 1), test_piece);
    BOOST_REQUIRE_EQUAL(Chessman::KING, test_board->ptr_piece(make_pair(1, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE, test_board->ptr_piece(make_pair(1, 1))->owner());
    delete test_board;
    delete test_piece;
}
...
BOOST_AUTO_TEST_CASE(put_8_white_pawns_at_chessboard)
{
    ...
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(1, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(1, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(2, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(2, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(3, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(3, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(4, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(4, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(5, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(5, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(6, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(6, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(7, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(7, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(8, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(8, 1))->owner());
...
BOOST_AUTO_TEST_CASE(put_8_black_pawns_at_chessboard)
{
    ...
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(1, 7))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(1, 7))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(2, 7))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(2, 7))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(3, 7))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(3, 7))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(4, 7))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(4, 7))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(5, 7))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(5, 7))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(6, 7))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(6, 7))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(7, 7))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(7, 7))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(8, 7))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(8, 7))->owner());
...
BOOST_AUTO_TEST_CASE(manually_setup_chessboard)
{
    ...
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(1, 2))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(1, 2))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(2, 2))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(2, 2))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(3, 2))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(3, 2))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(4, 2))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(4, 2))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(5, 2))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(5, 2))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(6, 2))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(6, 2))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(7, 2))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(7, 2))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::PAWN,     test_board->ptr_piece(make_pair(8, 2))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(8, 2))->owner());

    BOOST_REQUIRE_EQUAL(Chessman::ROOK,     test_board->ptr_piece(make_pair(1, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(1, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::KNIGHT,   test_board->ptr_piece(make_pair(2, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(2, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::BISHOP,   test_board->ptr_piece(make_pair(3, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(3, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::QUEEN,    test_board->ptr_piece(make_pair(4, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(4, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::KING,     test_board->ptr_piece(make_pair(5, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(5, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::BISHOP,   test_board->ptr_piece(make_pair(6, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(6, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::KNIGHT,   test_board->ptr_piece(make_pair(7, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(7, 1))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::ROOK,     test_board->ptr_piece(make_pair(8, 1))->type());
    BOOST_REQUIRE_EQUAL(Chessman::WHITE,    test_board->ptr_piece(make_pair(8, 1))->owner());
    ...
    BOOST_REQUIRE_EQUAL(Chessman::ROOK,     test_board->ptr_piece(make_pair(1, 8))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(1, 8))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::KNIGHT,   test_board->ptr_piece(make_pair(2, 8))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(2, 8))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::BISHOP,   test_board->ptr_piece(make_pair(3, 8))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(3, 8))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::QUEEN,    test_board->ptr_piece(make_pair(4, 8))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(4, 8))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::KING,     test_board->ptr_piece(make_pair(5, 8))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(5, 8))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::BISHOP,   test_board->ptr_piece(make_pair(6, 8))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(6, 8))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::KNIGHT,   test_board->ptr_piece(make_pair(7, 8))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(7, 8))->owner());
    BOOST_REQUIRE_EQUAL(Chessman::ROOK,     test_board->ptr_piece(make_pair(8, 8))->type());
    BOOST_REQUIRE_EQUAL(Chessman::BLACK,    test_board->ptr_piece(make_pair(8, 8))->owner());
...
BOOST_AUTO_TEST_CASE(ptr_piece_invalid_x_parameterer)
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(9, 1)), std::invalid_argument);
    delete test_board;
}

BOOST_AUTO_TEST_CASE(ptr_piece_invalid_y_parameterer)
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(1, 9)), std::invalid_argument);
    delete test_board;
}

BOOST_AUTO_TEST_CASE(ptr_piece_invalid_x_y_parameterers)
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(9, 9)), std::invalid_argument);
    delete test_board;
}

BOOST_AUTO_TEST_CASE(ptr_piece_invalid_x_y_parameterers2)
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(0, 0)), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(9, 1))->owner(), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(1, 9))->owner(), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(9, 9))->owner(), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(0, 0))->owner(), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(9, 1))->type(), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(1, 9))->type(), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(9, 9))->type(), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(0, 0))->type(), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(9, 1))->unicode(), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(1, 9))->unicode(), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(9, 9))->unicode(), std::invalid_argument);
    delete test_board;
}
...
{
    Chessboard::Board* test_board = new Chessboard::Board;
    BOOST_CHECK_THROW(test_board->ptr_piece(make_pair(0, 0))->unicode(), std::invalid_argument);
    delete test_board;
}
