...
BOOST_AUTO_TEST_CASE(king_white)
{
    ...
    shared_ptr<King> king {new King(Chessman::WHITE, make_pair(1, 1))};
...
{
    Debug::Log::test_func_head("king_white");
    shared_ptr<King> king {new King(Chessman::BLACK, make_pair(1, 1))};
    BOOST_REQUIRE_EQUAL(Chessman::KING, king->type());
...
BOOST_AUTO_TEST_CASE(king_valid_move)
{
    ...
    shared_ptr<King> test_piece {new King(Chessman::WHITE, make_pair(4, 4))};
...
BOOST_AUTO_TEST_CASE(king_castling_right)
{
    ...
    shared_ptr<Board> test_board {new Board};
    shared_ptr<King> test_piece {new King(Chessman::WHITE, make_pair(5, 1))};
    shared_ptr<Rook> test_piece_2 {new Rook(Chessman::WHITE, make_pair(8, 1))};
...
BOOST_AUTO_TEST_CASE(king_castling_left)
{
    ...
    shared_ptr<Board> test_board {new Board};
    shared_ptr<King> test_piece {new King(Chessman::WHITE, make_pair(5, 1))};
    shared_ptr<Rook> test_piece_2 {new Rook(Chessman::WHITE, make_pair(1, 1))};
    test_board->place_piece(make_pair(5, 1), test_piece);
...
BOOST_AUTO_TEST_CASE(king_castling_left_blocked)
{
    ...
    shared_ptr<King> test_piece {new King(Chessman::WHITE, make_pair(5, 1))};
    shared_ptr<Rook> test_piece_2 {new Rook(Chessman::WHITE, make_pair(1, 1))};
    shared_ptr<Rook> test_piece_3 {new Rook(Chessman::BLACK, make_pair(4, 4))};
    test_board->place_piece(make_pair(5, 1), test_piece);
    test_board->place_piece(make_pair(1, 1), test_piece_2);
...
BOOST_AUTO_TEST_CASE(king_castling_right_black_blocked)
{
    ...
    shared_ptr<Board> test_board {new Board};
    shared_ptr<King> test_piece {new King(Chessman::BLACK, make_pair(5, 8))};
    shared_ptr<Rook> test_piece_2 {new Rook(Chessman::BLACK, make_pair(8, 8))};
    shared_ptr<Rook> test_piece_3 {new Rook(Chessman::WHITE, make_pair(6, 3))};
...
BOOST_AUTO_TEST_CASE(king_castling_right_blocked)
{
    ...
    shared_ptr<King> test_piece {new King(Chessman::WHITE, make_pair(5, 1))};
    shared_ptr<Rook> test_piece_2 {new Rook(Chessman::WHITE, make_pair(8, 1))};
    shared_ptr<Rook> test_piece_3 {new Rook(Chessman::BLACK, make_pair(7, 4))};
    test_board->place_piece(make_pair(5, 1), test_piece);
    test_board->place_piece(make_pair(8, 1), test_piece_2);
...
BOOST_AUTO_TEST_CASE(king_castling_left_black_blocked)
{
    ...
    shared_ptr<King> test_piece {new King(Chessman::BLACK, make_pair(5, 8))};
    shared_ptr<Rook> test_piece_2 {new Rook(Chessman::BLACK, make_pair(1, 8))};
    shared_ptr<Rook> test_piece_3 {new Rook(Chessman::WHITE, make_pair(3, 3))};
    test_board->place_piece(make_pair(5, 8), test_piece);
    test_board->place_piece(make_pair(1, 8), test_piece_2);
...
BOOST_AUTO_TEST_CASE(king_list_legal_moves)
{
    ...
    shared_ptr<King> test_piece {new King(Chessman::WHITE, make_pair(1, 1))};
    shared_ptr<Rook> test_piece_2 {new Rook(Chessman::BLACK, make_pair(2, 8))};
...
BOOST_AUTO_TEST_CASE(king_list_legal_moves_2)
{
    ...
    shared_ptr<King> test_piece {new King(Chessman::WHITE, make_pair(1, 1))};
    shared_ptr<Rook> test_piece_2 {new Rook(Chessman::BLACK, make_pair(2, 8))};
    shared_ptr<Rook> test_piece_3 {new Rook(Chessman::BLACK, make_pair(8, 2))};
    test_board->place_piece(make_pair(1, 1), test_piece);
    test_board->place_piece(make_pair(2, 8), test_piece_2);
...
BOOST_AUTO_TEST_CASE(king_list_legal_moves_3)
{
    ...
    Board* test_board {new Board};
    shared_ptr<King> test_piece {new King(Chessman::WHITE, make_pair(2, 2))};
